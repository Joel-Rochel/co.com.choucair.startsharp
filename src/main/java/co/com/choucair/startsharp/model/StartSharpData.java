package co.com.choucair.startsharp.model;

public class StartSharpData {
    private String strUsername;
    private String strPassword;
    private String strNameBusinessUnit;
    ...
    public String getStrConfirmButton() {
        return strConfirmButton;
    }

    public void setStrConfirmButton(String strConfirmButton) {
        this.strConfirmButton = strConfirmButton;
    }
    ...
    public void setStrMeetingType(String strMeetingType) {
        this.strMeetingType = strMeetingType;
    }
    ...
    public void setStrStartHour(String strStartHour) {
    ...
    public void setStrEndHour(String strEndHour) {
    ...
    public String getStrNameBusinessUnit() {
        return strNameBusinessUnit;
    }

    public void setStrNameBusinessUnit(String strNameBusinessUnit) {
        this.strNameBusinessUnit = strNameBusinessUnit;
    }
